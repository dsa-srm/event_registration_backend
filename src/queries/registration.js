...
class RegistrationQueries {
    ...
    static updateRegistration(registrationId, user_id, 
    // user_club: string,
    user_event) {
        return __awaiter(this, void 0, void 0, function* () {
            yield aws_1.default.none("UPDATE public.registrations SET user_id = $1, user_event = $2 WHERE id = $3", [user_id, user_event, registrationId]);
        });
    }
    ...
    static registerUser(t, registrationId, id, 
    // user_club: string,
    user_event, registration_created_at, registration_updated_at) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield t.none("INSERT INTO public.registrations(id, user_id, user_event, created_at, updated_at) VALUES($1, $2, $3, $4, $5)", [
                registrationId,
                id,
                // user_club,
                user_event,
